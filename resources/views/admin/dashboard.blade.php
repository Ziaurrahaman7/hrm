<x-app-layout>
    <div class="space-y-6">
        ...
        <div>
            ...
            <p class="mt-2 text-gray-600">Welcome to HRM Admin Panel</p>
        </div>
        ...
        <div class="bg-white shadow rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                    <a href="{{ route('admin.users') }}" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                        Manage Users
                    </a>
