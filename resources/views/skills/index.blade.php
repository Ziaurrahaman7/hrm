<x-app-layout>
    <div class="space-y-6">
        ...
        <div class="bg-white shadow rounded-lg p-6">
            ...
            <form action="{{ route('skills.store') }}" method="POST" class="flex gap-4">
                @csrf
                <input type="text" name="name" placeholder="Skill Name" class="flex-1 border border-gray-300 rounded-md px-3 py-2" required>
